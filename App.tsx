...
const App: React.FC = () => {
  ...
  const applyTemplate = (type: 'classic' | 'editorial' | 'bold' | 'minimal') => {
    ...
    const layouts: Record<string, any> = {
      classic: {
        overlay: 25,
        headline:    { align: 'center', size: 30, w: 90, feed: { x: 50, y: 40 }, story: { x: 50, y: 42 } },
      ...
      editorial: {
        overlay: 32,
        headline:    { align: 'left', size: 27, w: 80, feed: { x: 50, y: 50 }, story: { x: 50, y: 50 } },
      ...
      bold: {
        overlay: 45,
        headline:    { align: 'center', size: 36, w: 92, feed: { x: 50, y: 36 }, story: { x: 50, y: 40 } },
      ...
      minimal: {
        overlay: 12,
        headline:    { align: 'center', size: 23, w: 82, feed: { x: 50, y: 62 }, story: { x: 50, y: 62 } },
    ...
    setState(prev => {
      ...
      return {
        ...prev,
        // Las plantillas solo acomodan los textos; no tocan el logo, el recurso ni el fondo.
